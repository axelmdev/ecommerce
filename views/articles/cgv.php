 ...
 <div class="container">
 	<div class="row">
 		<div class="main col-xs-12 col-sm-12 col-md-8">
			...
			<h3>Description du document et rapport avec les conditions d’achat</h3>
			<p>
				...
				<ol>
					...
					<li>Conséquences de tout non-paiement total ou partiel, à la date de paiement indiquée sur la facture :
						<ul>
							...
							<li>perte des rabais, ristournes, remises, éventuellement consentis par le Vendeur mais non encore réglés,</li>
							<li>paiement comptant pour les livraisons des deux commandes suivant la date de constatation du défaut de règlement à bonne date.</li>
							<li>Toute déduction unilatérale de la part de l’Acheteur sur l’un de ses paiements serait considérée comme un défaut de paiement et pourra entraîner l’ensemble des conséquences ci-dessus.</li>
						</ul>
					</li>
			...
			<p>
				Toutes les marchandises restent la propriété du Vendeur jusqu’au complet paiement du prix. 
				Il est précisé que par complet paiement du prix le Vendeur entend l’encaissement effectif du titre de paiement et non pas la remise d’un titre créant une obligation de payer.
				...
				Dans tous les cas, Le Vendeur est subrogée dans les droits de l’Acheteur en ce qui concerne toutes sommes ou indemnités qui pourraient lui être dues, pour quelque raison que ce soit, et notamment d’assurance, jusqu’à due concurrence du prix des marchandises livrées et non encore payées.
			</p>
